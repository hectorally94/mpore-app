  ...
  return (
    <Card   imgSrc="https://t4.ftcdn.net/jpg/02/18/39/49/240_F_218394966_Nrv1qTeQxsZgJ5WaHnZHqd7vd2Xvxr8A.jpg"  >
      ...
      <p className="font-normal text-gray-700 dark:text-gray-400">
        ...
        order. Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological 
        order.
      </p><Button color="button_primary" onClick={handleClick}  >
          Plus d'info
