...
export const PublicationDetails: React.FC<BlogProps> = ({ selectedCategory }) => {
  const posts: Post[] = [
    {
    ...
    <div>
      <div className="grid gap-4">
        ...
        {posts.map(post => (
         ...
         {/* Button container */}
            {/* Backward button */}
            <button onClick={handleClick} className="bg-blue-500 mb-4 mr-20 ml-20 text-white font-bold py-2 px-4 rounded text-center">
              Retour au blog
            </button>
